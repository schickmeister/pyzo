...
from .tokens import (CommentToken, StringToken,
    ...
    TodoCommentToken, OpenParenToken, CloseParenToken, BuiltinToken)
...
python2Builtins = set([ 'abs', 'all', 'any', 'basestring', 'bin', 'bool',
        ...
        'unichr', 'unicode', 'vars', 'zip', '__import__'])

#Source: https://docs.python.org/3.6/library/functions.html
python3Builtins = set([ 'abs', 'all', 'any', 'ascii', 'bin', 'bool',
...
class PythonParser(Parser):
    ...
    _keywords = pythonKeywords_keywords = pythonKeywords
    _builtin_functions = pythonBuiltins
    ...
    def _findNextToken(self, line, pos):
        ...
        if match.group(1) is not None:
            ...
            elif identifier in self._builtin_functions:
                self._identifierState(None)
                tokens.append( BuiltinToken(*tokenArgs))
...
class Python2Parser(PythonParser):
    ...
    _builtin_functions = python2Builtins
...
class Python3Parser(PythonParser):
    ...
    _builtin_functions = python3Builtins
